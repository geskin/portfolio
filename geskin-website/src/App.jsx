  ...
  return (
    <BrowserRouter>
      ...
      <div className="h-screen no-scrollbar overflow-y-scroll snap-y snap-mandatory scroll-smooth">
        <Container sx={{ mt: 4 }}>
          {/* Intro Section */}
          <section id="intro" className="text-black dark:text-white h-screen snap-start flex justify-center items-center px-4 sm:px-6 bg-white dark:bg-gray-900 sm:py-4">
