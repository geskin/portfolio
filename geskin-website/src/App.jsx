  ...
  return (
    <BrowserRouter>
      ...
      <div className="h-screen no-scrollbar overflow-y-scroll snap-y snap-mandatory scroll-smooth">
        <Container sx={{ mt: 4 }}>
          {/* Intro Section */}
          <section id="intro" className="text-black dark:text-white h-screen snap-start flex justify-center items-center px-4 sm:px-6 bg-white dark:bg-gray-900 sm:py-4 sm:pt-2 mt-2">
          ...
          {/* About Me */}
          <section id="about" className="text-black dark:text-white min-h-screen snap-start flex flex-col justify-center items-center px-4 sm:px-6 sm:pt-2 mt-2 py-8">
          ...
          {/* Projects */}
          <section id="projects" className="text-black dark:text-white min-h-screen snap-start flex flex-col justify-center items-center px-4 sm:px-6 sm:pt-2 mt-2 py-4">
          ...
          {/* Skills */}
          <section id="skills" className="text-black dark:text-white min-h-screen snap-start flex flex-col justify-center items-center px-4 sm:px-6 sm:pt-2 mt-2 py-4">
          ...
          {/* Education */}
          <section id="education" className="text-black dark:text-white min-h-screen snap-start flex flex-col justify-center items-center px-4 sm:px-6 sm:pt-2 mt-2 py-4">
          ...
          {/* Contact */}
          <section id="contact" className="min-h-screen snap-start flex flex-col justify-center items-center text-black px-4 sm:px-6 sm:mt-0 py-4 bg-[whitesmoke]">
